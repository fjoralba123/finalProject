...
,['key'=>$key->id])}}">
        ...
        @method("put")
                    ...
                    <div class="form-group">
                        <br>
                         <label for="extra">Extra</label>
                          <input type="text" class="form-control" id="extra" name="extra" value='{{$key->extra}}' placeholder="Extras Json Format">
                           @error('extra')
            ...
            <br>
            <button class="btn btn-warning btn-block confirm-button" type="submit">Confirm edit</button>
            </form>
            </div>
